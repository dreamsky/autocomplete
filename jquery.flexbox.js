...
/*                else
        ...
        function processKeyDown(e) {
            ...
            if (tab) if (getCurr()) selectCurr(e);
        ...
        function flexbox(p, arrowOrPagingClicked, prevQuery) {
            ...
            if (q.length >= o.minChars || arrowOrPagingClicked) {
                ...
                if (cached) {
                	...
                	// q : query string
                	// cutom - pageNum : current page 
                	// custom - pageSize : each page count
                    var params = { 
						q: q,
						p: p,
						s: pageSize,
/*						mobile: q,
                    ...
                    // add extra custom prams
					if(o.prmNames){
						for(var k in o.prmNames){
							if(params[k]!==undefined){
								params[o.prmNames[k]]=params[k];
							}
						}
					}
					// merge the custom data
                    if(o.data)
                    	params=$.extend(params,o.data);
                    ...
                    case 13: // Enter
                        if (/^\d+$/.test(page) && page > 0 && page <= totalPages)
                        	...
                        	if(isNaN(page)){
                        		...
                        		alert('您输入的页码超出范围，总共只有'+totalPages+'页！');
                        	}
                        }
        ...
        function outputPagingLinks(totalPages, currentPage, totalResults) {
            ...
            if (o.paging.showSummary) {
                ...
                var $summary=$('<span></span>')
                    .addClass(o.paging.summaryClass)
                    .html(html)
                    .appendTo($paging);
                
                if(o.enableSelAll){
	                $summary.append('<span style="">全选</span>');
	                $('<input type="checkbox" id="sel-all" style="position:relative;top:10px;width:20px;" />')
	                	.click(function(){
	                		o.selCallback.apply(this);
	                	}).appendTo($summary);
                }
            }
        }
        ...
        function selectCurr(event) {
            ...
            if ($curr) {
				...
				var curValue={name:$curr.attr('val'),value:$curr.find("input").val()};
                if (o.onSelect) {
                    o.onSelect.apply($input[0],[curValue]);
                }
				/*
                if (o.onSelect) {
                    o.onSelect.apply($curr[0],[event]);
                }*/
            }
        }
...
/*            for (var prop in o) {
    ...
    $.fn.flexbox.defaults = {
        ...
        data: {}, // custom data
        defaultQuery: false, //whether load data after initation
...
/*    // query defaultInput after initation
    $.fn.defaultQuery = function(defaultInput) {
        if (timeout) clearTimeout(timeout);
        var me=this;
        var timeout = setTimeout(function() { me.flexbox(1, false, defaultInput!==undefined?defaultInput:''); }, 100);
    };*/
